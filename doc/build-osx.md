...
4. Enter "vsync-qt" as project name, enter src/qt as location
...
vsyncd/vsync-cli binaries are not included in the vsync-Qt.app bundle.

If you are building `vsyncd` or `vsync-qt` for others, your build machine should be set up
...
commands:
    ...
    echo -e "rpcuser=vsyncrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Vsync/vsync.conf"
...
-------
    ...
    ./vsyncd -daemon # to start the vsync daemon.
    ./vsync-cli --help  # for a list of command-line options.
    ./vsync-cli help    # When the daemon is running, to get a list of RPC commands
